    ...
    */
    static public void sortTemperatures(String inputName, String outputName) throws IOException {
        ...
        while ((line = bufferedReader.readLine()) != null) {
            ...
            if (num > 500 || num < -273) throw new IllegalArgumentException();
            list.add(num);
        }
    ...
    */
    static public void sortSequence(String inputName, String outputName) throws IOException {
        ...
        while ((line = bufferedReader.readLine()) != null) {
            ...
            map.put(Integer.valueOf(line), map.getOrDefault(Integer.valueOf(line), 0) + 1);
        }
        int maxFrequency = Collections.max(map.values());

        for (Map.Entry<Integer, Integer> entry : map.entrySet()) {
            if (entry.getValue() == maxFrequency && entry.getKey() < remember) {
                remember = entry.getKey();
            }
        }
        for (int n = 0; n < list.size(); ) {
            if (list.get(n) == remember && n == 0) {
                list.remove(n);
                n = 0;
            } else if (list.get(n) == remember && n != 0) {
                list.remove(n);
                n--;
            } else n++;
        }
